---
layout: post
title:  "『DJs for anywhere 001』の配信業務を担当しました。"
...
[Annie beatz] (通称アニーさん)の音管理にも救われ、配信にも非常にクリアな音質がもたらされました。フェーダーからオーディオインターフェースの流れで、これを常時管理する人員が居たので、カメラはカメラ、スイッチャーはスイッチャーと、それぞれ分業が成立し、クオリティも前回より格段に上がっています。
